...
public class ThreadFrameself implements Runnable, Observer
{
    ...
    public ThreadFrameself(String ipAddressCollector, int portCollector, String ipAddressDispatcher, int portSendDispatcher, int portListenDispatcher, int sleep_time_thread)
    {
    	...
    	disframeself = new DispatcherFrameself(this, this.ipAddressDispatcher, this.portSendDispatcher, this.portListenDispatcher);
